...
export default function Footer() {
  return <footer className="site-footer">
    ...
    <div className="footer-bottom"><span>&copy; 2026 Tahsin Sajid. All rights reserved.</span><div><Link href="/privacy-policy">Privacy Policy</Link><Link href="/terms-and-conditions">Terms &amp; Conditions</Link><a href="#home" aria-label="Back to top"><ArrowUpRight size={16} /></a></div></div>
  </footer>;
}